...
label firstGameLobby:
    if current_stage == 0:
        ...
        $ points = [20, 10, 5]
        $ chosen_point = 0
        call startFirstGame from _call_startFirstGame
        ...
        $ points = [10, 20, 5]
        $ chosen_point = 0
        call startFirstGame from _call_startFirstGame_1
        ...
        $ points = [5, 20, 10]
        $ chosen_point = 0
        call startFirstGame from _call_startFirstGame_2
        ...
        $ points = [10, 5, 20]
        $ chosen_point = 0
        call startFirstGame from _call_startFirstGame_3
        ...
        $ points = [20, 10, 5]
        $ chosen_point = 0
        call startFirstGame from _call_startFirstGame_4
...
label secondGameLobby:
    if times == 1:
        call start_second_game pass (color0="#ff0000", colors1=["#ffa500", "#ffae00", "#ff009d", "#ff0000"]) from _call_start_second_game
    elif times == 2:
        call start_second_game pass (color0="#9ccbf1", colors1=["#4d7ec7", "#9ccbf1", "#0f737a", "#fcd912"]) from _call_start_second_game_1
    elif times == 3:
        call start_second_game pass (color0="#57ff15", colors1=["#10ffd7", "#9dff00", "#57ff15", "#12c5fc"]) from _call_start_second_game_2
    elif times == 4:
        call start_second_game pass (color0="#ff15c4", colors1=["#ff109b", "#e100ff", "#e415ff", "#ff15c4"]) from _call_start_second_game_3
    elif times == 5:
        call start_second_game pass (color0="#5c4352", colors1=["#5c4352", "#4f4261", "#434f57", "#4a334d"]) from _call_start_second_game_4
    elif times == 6:
        call start_second_game pass (color0="#9dff00", colors1=["#00ff15", "#72d303", "#9dff00", "#48ff1a"]) from _call_start_second_game_5
    elif times == 7:
        call start_second_game pass (color0="#3700ff", colors1=["#5900ff", "#bb03d3", "#00aeff", "#3700ff"]) from _call_start_second_game_6
    elif times == 8:
        call start_second_game pass (color0="#ffd000", colors1=["#c29008", "#ffd000", "#eeff00", "#ff631a"]) from _call_start_second_game_7
    else:
